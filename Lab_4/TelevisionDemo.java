...
public class TelevisionDemo
	...
	public static void main(String[] args)
	{
		...
		//declare and instantiate portable object of Television
		Television portable = new Television("Sharp", 19);
		//call power method to turn TV on
		portable.power();
		//Get Channel Number
		System.out.println(portable.getScreenSize() + "-inch " +
				portable.getManufacturer() + " has been turned on.");
		//Change Channel and Increase Volume by 2
		System.out.print("What channel do you want? ");
		portable.setChannel(keyboard.nextInt());
		portable.increaseVolume();
		portable.increaseVolume();
		//Display Channel Number and Volume
